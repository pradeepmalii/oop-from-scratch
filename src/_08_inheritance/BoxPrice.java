...
//after these multiple inheritance comes which is not supported in java(one class inherite/extends more than one class) but we can achieve it's functionality using interfaces
